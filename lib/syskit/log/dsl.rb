...
module Syskit
    module Log
        ...
        module DSL
            ...
            # Convert fields of a data stream into a Rover frame
            #
            ...
            def to_rover_frame(*streams, accurate: false, timeout: nil)
                return ::Rover::DataFrame.new if streams.empty?
                ...
                builders = streams.map { |s| RoverFrameBuilder.new(s.type) }
                yield(*builders)
